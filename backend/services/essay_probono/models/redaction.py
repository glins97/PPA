...
class Redaction(models.Model):
    ...
    grade_1 = models.IntegerField(verbose_name='competência 1', default=0, editable=False)
    grade_2 = models.IntegerField(verbose_name='competência 2', default=0, editable=False)
    grade_3 = models.IntegerField(verbose_name='competência 3', default=0, editable=False)
    grade_4 = models.IntegerField(verbose_name='competência 4', default=0, editable=False)
    grade_5 = models.IntegerField(verbose_name='competência 5', default=0, editable=False)
